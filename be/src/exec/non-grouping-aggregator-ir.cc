...
Status NonGroupingAggregator::ProcessBatchNoGrouping(RowBatch* batch) {
...
Status NonGroupingAggregator::ProcessBatch(RowBatch* batch,
...
template <bool AGGREGATED_ROWS>
void IR_ALWAYS_INLINE NonGroupingAggregator::EvalAndHashPrefetchGroup(RowBatch* batch,
...
template <bool AGGREGATED_ROWS>
Status NonGroupingAggregator::ProcessRow(
...
template <bool AGGREGATED_ROWS>
Status NonGroupingAggregator::AddIntermediateTuple(Partition* __restrict__ partition,
...
Status NonGroupingAggregator::ProcessBatchStreaming(bool needs_serialize,
...
bool NonGroupingAggregator::TryAddToHashTable(HashTableCtx* __restrict__ ht_ctx,
...
template Status NonGroupingAggregator::ProcessBatch<false>(
    RowBatch*, TPrefetchMode::type, HashTableCtx*);
template Status NonGroupingAggregator::ProcessBatch<true>(
    RowBatch*, TPrefetchMode::type, HashTableCtx*);
