...
class Aggregator {
 ...
 private:
  ...
  typedef Status (*ProcessBatchNoGroupingFn)(Aggregator*, RowBatch*);
  ...
  typedef Status (*ProcessBatchFn)(
      Aggregator*, RowBatch*, TPrefetchMode::type, HashTableCtx*);
  /// Jitted ProcessBatch function pointer. Null if codegen is disabled.
  ProcessBatchFn process_batch_fn_;

  typedef Status (*ProcessBatchStreamingFn)(Aggregator*, bool, TPrefetchMode::type,
  ...
  struct Partition {
    Partition(Aggregator* parent, int level, int idx)
