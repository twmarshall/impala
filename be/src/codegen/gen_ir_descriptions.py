...
ir_functions = [
  ...
  ["GROUPING_AGG_PROCESS_BATCH_UNAGGREGATED",
   "_ZN6impala18GroupingAggregator12ProcessBatchILb0EEENS_6StatusEPNS_8RowBatchENS_13TPrefetchMode4typeEPNS_12HashTableCtxE"],
  ["NON_GROUPING_AGG_PROCESS_BATCH_NO_GROUPING",
   "_ZN6impala21NonGroupingAggregator22ProcessBatchNoGroupingEPNS_8RowBatchE"],
  ["GROUPING_AGG_PROCESS_BATCH_STREAMING",
   "_ZN6impala18GroupingAggregator21ProcessBatchStreamingEbNS_13TPrefetchMode4typeEPNS_8RowBatchES4_PNS_12HashTableCtxEPi"],
  ["AVG_UPDATE_BIGINT",
