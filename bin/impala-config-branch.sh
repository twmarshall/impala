...
if ! ${IS_STANDALONE_IMPALA_BUILD}; then
    ...
    export CDP_KUDU_VERSION=1.12.0.7.1.1.0-SNAPSHOT
    export CDP_KUDU_JAVA_VERSION=1.12.0.7.1.1.0-SNAPSHOT
    ...
    export IMPALA_KUDU_VERSION=1.12.0.7.1.1.0-SNAPSHOT
    export IMPALA_KUDU_JAVA_VERSION=1.12.0.7.1.1.0-SNAPSHOT
    return 0
fi;
