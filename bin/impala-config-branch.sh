...
if ! ${IS_STANDALONE_IMPALA_BUILD}; then
    export CDP_HADOOP_VERSION=3.1.1.7.2.3.0-SNAPSHOT
    export CDP_HBASE_VERSION=2.2.5.7.2.3.0-SNAPSHOT
    export CDP_HIVE_VERSION=3.1.3000.7.2.3.0-SNAPSHOT
    export CDP_KNOX_VERSION=1.3.0.7.2.3.0-SNAPSHOT
    export CDP_KUDU_VERSION=1.12.0.7.2.3.0-SNAPSHOT
    export CDP_KUDU_JAVA_VERSION=1.12.0.7.2.3.0-SNAPSHOT
    export CDP_RANGER_VERSION=2.0.0.7.2.3.0-SNAPSHOT
    export CDP_TEZ_VERSION=0.9.1.7.2.3.0-SNAPSHOT
    export CDP_OZONE_VERSION=0.6.0.7.2.3.0-SNAPSHOT
    export CDP_ATLAS_VERSION=2.0.0.7.2.3.0-SNAPSHOT
    export CDP_AVRO_JAVA_VERSION=1.8.2.7.2.3.0-SNAPSHOT
    export CDP_PARQUET_VERSION=1.10.99.7.2.3.0-SNAPSHOT
    # TODO: remove these IMPALA_KUDU_* once there is proper support of CDP Kudu
    export IMPALA_KUDU_VERSION=1.12.0.7.2.3.0-SNAPSHOT
    export IMPALA_KUDU_JAVA_VERSION=1.12.0.7.2.3.0-SNAPSHOT
    return 0
fi;
